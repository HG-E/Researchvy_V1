...
// Short words only — "deserves to be [word]" stays on one line at all breakpoints
  ...
  return (
    <section className="relative overflow-hidden" style={{ backgroundColor: "#FAFAF8" }}>
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 65% 55% at 25% -5%, rgba(37,99,235,0.07) 0%, transparent 60%), " +
            "radial-gradient(ellipse 40% 40% at 90% 95%, rgba(245,158,11,0.04) 0%, transparent 50%)",
        }}
      />
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-14 pb-10 sm:pt-20 sm:pb-16">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            {/*
              Headline — always exactly 2 visual lines:
              Line 1: "Great research"
              Line 2: "deserves to be [rotating word]"
              · clamp(1.6rem, 3.5vw, 3rem) sizes the font so line 2 fits within the
                half-width column at every breakpoint (lg col ≈ 448 px → max 3rem ≈ fits)
              · sm:whitespace-nowrap prevents the rotating word from ever wrapping
            */}
            <motion.h1
            ...
            <motion.p
              ...
              className="text-base sm:text-lg max-w-xl mx-auto lg:mx-0 mb-2 leading-relaxed"
              style={{ color: "#4B5563" }}
            >
          ...
          >
            {/* Floating annotation card — top right, matches flyer design */}
            <motion.div
              initial={{ opacity: 0, scale: 0.85, y: -8 }}
              animate={{ opacity: 1, scale: 1, y: 0 }}
              transition={{ duration: 0.6, delay: 0.9 }}
              className="absolute -top-5 -right-4 z-20 rounded-2xl px-4 py-3.5 shadow-lg border"
              style={{ backgroundColor: "#FFFFFF", borderColor: "#E5E7EB", minWidth: "180px" }}
            >
            ...
            >
              ...
              <div
                ...
                style={{ background: "linear-gradient(135deg, #EFF6FF 0%, #DBEAFE 50%, #FEF3C7 100%)" }}
              />
              <Image
              ...
              <div
                className="absolute inset-0"
                style={{ background: "linear-gradient(180deg, rgba(37,99,235,0.03) 0%, rgba(15,23,42,0.22) 100%)" }}
              />

              {/* Bottom dark caption badge */}
              <div
            ...
            {/* Floating bottom-right: live cohort badge */}
            <motion.div
