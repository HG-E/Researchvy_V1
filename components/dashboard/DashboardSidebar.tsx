...
export function DashboardSidebar({ user }: { user: DashUser }) {
  ...
  return (
    ...
    >
      {/* Logo */}
      <div className="flex items-center px-5 py-4 border-b" style={{ borderColor: "#1E293B" }}>
        ...
        {NAV_ITEMS.map(({ href, label, Icon }) => {
          ...
          return (
            <Link
              ...
              onMouseEnter={(e) => { if (!isActive) { e.currentTarget.style.backgroundColor = "#111827"; e.currentTarget.style.color = "#9CA3AF"; } }}
      ...
      <div className="px-3 pb-4 border-t pt-3" style={{ borderColor: "#1E293B" }}>
        <Link
          ...
          className="flex items-center gap-3 px-3 py-2.5 rounded-xl mb-1 transition-colors hover:bg-[#1E293B]"
        >
        ...
        <button
          ...
          style={{ color: "#4B5563" }}
          onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = "#111827"; e.currentTarget.style.color = "#EF4444"; }}
