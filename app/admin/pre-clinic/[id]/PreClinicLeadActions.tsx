...
const STATUSES = [
  ...
  { value: "attended",  label: "Attended",  color: "#8B5CF6" },
  { value: "no_show",   label: "No-show",   color: "#4B5563" },
...
export function PreClinicLeadActions({ registrationId, currentStatus, currentNotes }: Props) {
  ...
  async function handleSave() {
    setSaving(true);
    await fetch(`/api/admin/pre-clinic/${registrationId}`, {
      method:  "PATCH",
    ...
    >
      ...
      <div>
        ...
        <textarea
          ...
          rows={4}
          placeholder="Add follow-up notes, session attendance, clinic pitch outcome…"
