...
export default function ManageClinicsPage() {
  return (
    <section className="flex flex-col items-center justify-center min-h-[60vh] text-center px-6" style={{ backgroundColor: "#0F172A", color: "#F9FAFB" }}>
      ...
      <h1 className="text-4xl font-bold mb-4" style={{ fontFamily: "var(--font-serif)" }}>Manage Clinics</h1>
      <p className="text-base max-w-lg" style={{ color: "#9CA3AF" }}>Create, edit, and manage clinics.</p>
    </section>
  );
}
