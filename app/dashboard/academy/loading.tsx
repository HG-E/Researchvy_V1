      ...
      {[1, 2, 3].map((i) => (
        <div key={i} className="rounded-2xl border p-6" style={{ backgroundColor: "#FFFFFF", borderColor: "#E2E8F0" }}>
          <div className="flex items-start justify-between mb-4">
            ...
            <div className="h-6 w-16 rounded-full" style={{ backgroundColor: "#F1F5F9" }} />
          </div>
          ...
          <div className="mb-4">
            <div className="flex justify-between mb-1">
              ...
              <div className="h-3 w-10 rounded" style={{ backgroundColor: "#F1F5F9" }} />
            </div>
          ...
          <div className="flex items-center justify-between">
            <div className="h-4 w-36 rounded" style={{ backgroundColor: "#F1F5F9" }} />
