  ...
  return (
    <div className="max-w-3xl mx-auto space-y-6 animate-pulse">
      ...
      <div className="flex gap-2">
        {[1, 2, 3, 4].map((i) => (
          <div key={i} className="h-8 w-20 rounded-full" style={{ backgroundColor: "#1E293B" }} />
        ))}
      </div>
      ...
      <div className="rounded-2xl border overflow-hidden" style={{ backgroundColor: "#0F172A", borderColor: "#1E293B" }}>
        {[1, 2, 3, 4, 5, 6].map((i) => (
          ...
          >
            <div className="h-8 w-8 rounded-full shrink-0 mt-0.5" style={{ backgroundColor: "#1E293B" }} />
            <div className="flex-1 min-w-0">
              <div className="h-4 w-48 rounded mb-2" style={{ backgroundColor: "#1E293B" }} />
              <div className="h-3 w-full rounded mb-1" style={{ backgroundColor: "#1E293B" }} />
              <div className="h-3 w-2/3 rounded" style={{ backgroundColor: "#1E293B" }} />
            </div>
            <div className="h-3 w-16 rounded shrink-0" style={{ backgroundColor: "#1E293B" }} />
          </div>
        ))}
      </div>
    </div>
