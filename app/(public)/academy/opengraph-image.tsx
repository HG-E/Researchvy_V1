    ...
    >
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center" }}>
        ...
        <p style={{
          ...
          Self-paced research visibility courses. 5 levels, 36 lessons — start Level 1 for free.
        </p>
      </div>
        ...
        <div style={{ display: "flex", gap: "44px" }}>
          {[
            ...
            <div key={label} style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
              ...
              <span style={{ color: "#F9FAFB", fontSize: "16px", fontWeight: "600", fontFamily: "Arial, sans-serif" }}>
                {value}
              </span>
            </div>
          ))}
        </div>
        <span style={{ color: "#1E293B", fontSize: "13px", fontFamily: "Arial, sans-serif" }}>researchvy.com/academy</span>
      </div>
    </div>,
    { ...size },
  );
