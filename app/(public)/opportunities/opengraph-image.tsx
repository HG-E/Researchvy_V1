    ...
    >
      ...
      <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center" }}>
        ...
        <p style={{
          ...
          Grants, fellowships, travel bursaries, and calls for papers — curated for global researchers.
        </p>
      </div>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: "28px" }}>
          {["Grants", "Fellowships", "Travel Grants", "Call for Papers", "Awards"].map((t) => (
            <div key={t} style={{ display: "flex", alignItems: "center", gap: "7px" }}>
              ...
              <span style={{ color: "#6B7280", fontSize: "12px", fontFamily: "Arial, sans-serif" }}>{t}</span>
            </div>
          ))}
        </div>
        <span style={{ color: "#1E293B", fontSize: "13px", fontFamily: "Arial, sans-serif" }}>researchvy.com/opportunities</span>
      </div>
    </div>,
    { ...size },
  );
