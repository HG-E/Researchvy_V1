    ...
    <div className="min-h-screen" style={{ backgroundColor: "#080E1A" }}>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div className="mb-10">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold mb-3" style={{ fontFamily: "var(--font-serif)", color: "#F9FAFB" }}>
        ...
        {/* Form */}
        <div className="rounded-2xl border p-6 sm:p-8" style={{ backgroundColor: "#0F172A", borderColor: "#1E293B" }}>
