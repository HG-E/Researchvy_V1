  ...
  return (
    <div className="animate-pulse">
      ...
      <div className="max-w-3xl mx-auto text-center py-16 px-4">
        <div className="h-3 w-28 rounded mx-auto mb-4" style={{ backgroundColor: "#1E293B" }} />
        <div className="h-10 w-64 rounded mx-auto mb-4" style={{ backgroundColor: "#1E293B" }} />
        <div className="h-5 w-80 rounded mx-auto mb-2" style={{ backgroundColor: "#1E293B" }} />
        <div className="h-5 w-56 rounded mx-auto" style={{ backgroundColor: "#1E293B" }} />
      </div>
            ...
            <div key={i} className="rounded-2xl border p-6" style={{ backgroundColor: "#0F172A", borderColor: "#1E293B" }}>
              <div className="flex items-start justify-between mb-3">
                <div className="flex items-center gap-2">
                  <div className="h-5 w-5 rounded" style={{ backgroundColor: "#1E293B" }} />
                  <div className="h-5 w-24 rounded-full" style={{ backgroundColor: "#1E293B" }} />
                </div>
